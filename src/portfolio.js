...
const greeting = {
  ...
  subTitle: emoji(
    "A passionate software developer! 🚀 I Have experience and desire to create video games with Unity and UE5, and other applications utilizing .NET, ASP.NET, MERN stack, React Native, and other frameworks."
  ),
  resumeLink:
